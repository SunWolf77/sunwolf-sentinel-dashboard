...
def fetch_solar_wind():
    def inner(): 
        r = requests.get("https://services.swpc.noaa.gov/products/solar-wind-plasma.json", timeout=10)
...
def fetch_flares():
    def inner():
        r = requests.get("https://services.swpc.noaa.gov/json/goes/xray-flares-latest.json", timeout=10)
