...
# Historical matches: [proxy, outcome, delta_days, 'domain', geomag_kp, schumann_power]
historical_matches = [
    [0.8, 6.9, 1, 'EQ', 3.0, 26.0],     # Sanriku M6.9
    [0.95, 1.0, 0, 'VOLC', 3.0, 10.0],  # Fuego eruption
    [0.8, 1.0, 2, 'VOLC', 3.0, 10.0],   # Kilauea activity
    [0.85, 1.9, 4, 'SOL', 5.67, 74.0],  # Solar X1.9
    [0.7, 1.0, 1, 'VOLC', 5.0, 44.0],   # Fuego uptick Nov 28
    [0.89, 0.8, 0, 'VOLC', 3.0, 10.0],  # Tokara swarm
    [0.88, 1.9, 1, 'SOL', 2.0, 74.0],   # Solar X1.9 Dec 1
    [0.7, 1.0, 42, 'VOLC', 5.0, 13.0],  # Bezymianny Nov 25
    [0.7, 1.0, 2, 'VOLC', 4.67, 25.0]   # Fuego Nov 29-30
]
